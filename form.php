...
<body>
  ...
  <form action="confirm.php" method="post">
    ...
    <input type="text" id="phone" name="phone" placeholder="例）000-0000-0000 or 00000000000"><br><br>

    <label for="email">メールアドレス：</label>
    <input type="email" id="email" name="email" placeholder="例）〇〇@gmail.com"><br><br>
